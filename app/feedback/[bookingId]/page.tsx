  ...
  const fetchBookingDetails = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const foundBooking = data.booking || data;
        setBooking(foundBooking);
        
        // Block feedback if not explicitly completed
  ...
  if (accessDenied) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-red-50">
        <LandingHeader />
        <div className="flex items-center justify-center min-h-[60vh] px-4 -mt-10">
          <Card className="max-w-md w-full shadow-lg border-t-4 border-t-red-500">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-base mt-2">
                Reviews can only be written after your turf session has been fully completed. 
              </CardDescription>
            </CardHeader>
            <CardFooter className="flex justify-center pb-8">
              <Button onClick={() => router.push('/dashboard/player')} className="bg-red-600 hover:bg-red-700">
                Return to Dashboard
              </Button>
            </CardFooter>
          </Card>
