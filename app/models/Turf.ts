...
const TurfSchema = new mongoose.Schema(
  {
    ...
    customSport: {
      ...
      required: function (this: ITurf): boolean {
        return Boolean(
          this.sportsOffered && this.sportsOffered.includes("Other"),
        );
      },
    },
    amenities: {
    ...
    maxSurge: {
      type: Number,
      default: 0, // 0 = surge disabled
      min: 0,
      max: 30, // cap at 30% above base price
    },
...
export default mongoose.models.Turf ||
  mongoose.model<ITurf>("Turf", TurfSchema);