          ...
          <div className="flex justify-between items-center h-16">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className="text-right hidden lg:block">
                    ...
                    <p className="text-[10px] text-gray-400 mt-0.5">{user.businessName || 'Turf Owner'}</p>
                  </div>
              ...
              <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-xl border-gray-100 p-1">
                <DropdownMenuLabel className="text-xs text-gray-400 font-medium px-3">My Account</DropdownMenuLabel>
                ...
                <DropdownMenuItem onClick={() => router.push('/owner/bank-details')} className="rounded-lg cursor-pointer">
                  <CreditCard className="mr-2 h-4 w-4 text-gray-400" /> Payment Details
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => router.push('/owner/analytics')} className="rounded-lg cursor-pointer">
                  <BarChart3 className="mr-2 h-4 w-4 text-gray-400" /> Analytics
                </DropdownMenuItem>
                <DropdownMenuSeparator />
